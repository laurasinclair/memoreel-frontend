			...
			<Container>
				<Row>
					<Col
						...
						<p>
							...
							feels like home. A place where you can drop random stuff
							from your mind - daily. And then come back to relive the
							moments.
						</p>
					</Col>
				</Row>
				...
				<Row>
                  ...
                  Tetiana Kanafotska'
								...
								<p>
									A Ukrainian with a background in start-ups and
									marketing. Love good jokes, sushi and fixing bugs 🐞.
								</p>
							</div>
					...
					<Col
						...
						<div
							...
							<div className={styles.social_person}>
								...
								<p>
									From the Turkish Aegean coast, with an olive
									addiction and a designer background, still sprinkling
									creativity onto JS katas like confetti! 🎉
								</p>
							</div>
					...
					<Col
						...
						<div
							...
							<div className={styles.social_person}>
								...
								<p>
									Frenchie with a creative background and the odd
									ability to fix CSS problems in her sleep. Full-time
									croissant lover.
								</p>
							</div>
							<div className={styles.social_links}>
